...
export REPT_MAX_COMPLETION_LENGTH="${REPT_MAX_COMPLETION_LENGTH:-1024}"
export REPT_USE_VLLM="${REPT_USE_VLLM:-1}"
export REPT_OPENENV_MODE="${REPT_OPENENV_MODE:-episode}"
...
export REASON_BUDGET_NUM_QUESTIONS="${REASON_BUDGET_NUM_QUESTIONS:-4}"
